...
namespace PharmacyERP.Web.Controllers
{
    ...
    public class MedicineCategoryController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Upsert(MedicineCategoryViewModel model)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> QuickAdd([FromBody] QuickAddCategoryViewModel model)
        {
            if (!ModelState.IsValid)
